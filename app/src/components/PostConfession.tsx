...
export default function PostConfession() {
  ...
  const hasCooldown = cooldownRemaining && Number(cooldownRemaining) > 0
  ...
  return (
    <div className="p-6 bg-gray-900 rounded-lg border border-gray-800">
      ...
      {hasCooldown && (
        <div className="mb-4 p-3 bg-blue-900/20 border border-blue-600 rounded-lg">
          <p className="text-blue-400 text-sm">
            ⏳ Cooldown: {Math.ceil(Number(cooldownRemaining))} seconds remaining
          </p>
        </div>
      )}
      ...
      <button
        ...
        className="w-full py-3 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-700 disabled:cursor-not-allowed rounded-lg font-semibold transition-colors shadow-lg hover:shadow-blue-500/50"
      >
